...
/* TEXTO ÁUREO */
.box-aureo{background:#fffaf0;border-radius:8px;padding:14px 16px;margin:14px 0;font-style:italic;color:#5a3a00;text-align:justify}
.box-aureo .lbl{display:block;font-style:normal;font-size:10px;font-weight:900;color:#c9a14a;letter-spacing:2.5px;text-transform:uppercase;margin-bottom:8px;text-align:center}

/* VERDADE PRÁTICA */
.box-pratica{background:#f0faf5;border-radius:8px;padding:14px 16px;margin:14px 0;color:#1a3a2a;text-align:justify}
.box-pratica .lbl{display:block;font-size:10px;font-weight:900;color:#16a34a;letter-spacing:2.5px;text-transform:uppercase;margin-bottom:8px;text-align:center}
